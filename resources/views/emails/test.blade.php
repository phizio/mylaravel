                                    ...
                                    <table  border="0" cellpadding="0" cellspacing="0" align="left" class="deviceWidth">
                                        <tr>
                                            <td class="center" style="padding: 10px 0px 10px 0px">
                                                <a href="#"><img src="{{ $message->embed('img/logo/logo_aqua.png') }}"></a>
                                            </td>
                                        </tr>
                                    </table><!--End logo-->
                                    <!--Start nav-->
            ...
            <table width="700" border="0" cellpadding="0" cellspacing="0" align="center" class="deviceWidth">
                <tr>
                    <td valign="top" style="padding: 0px " class="center">
                        <a href="#"><img class="deviceWidth" src="{{ $message->embed('img/headliner/headliner_aqua.jpg') }}"></a>
                    </td>
                </tr>
            </table>
            <!-- Start Headliner-->
                                    ...
                                    <table  border="0" cellpadding="0" cellspacing="0" align="center" > 
                                        <tr>
                                            <td valign="top" style="padding: 20px 0px " class="center">
                                                <a href="#"><img width="45" hight="45" src="{{ $message->embed('img/icons/icon_layers_aqua.png') }}"></a>
                                            </td>
                                        </tr>
                                    </table>
                                    <table  border="0" cellpadding="0" cellspacing="0" align="center"> 
                            ...
                            <tr>
                                <td class="center">
                                    <table  border="0" cellpadding="0" cellspacing="0" align="center"> 
                                        <tr>
                                            <td valign="top" style="padding: 20px 0px " class="center">
                                                <a href="#"><img width="45" hight="45" src="{{ $message->embed('img/icons/icon_plane_aqua.png') }}"></a>
                                            </td>
                                        </tr>
                                    </table>
                                    <table  border="0" cellpadding="0" cellspacing="0" align="center"> 
                       ...
                       <table width="40%"  border="0" cellpadding="0" cellspacing="0" align="left" class="deviceWidth">
                            <tr>
                                <td valign="top" style="padding: 40px 20px " class="center">
                                    <a href="#"><img width="300" hight="170" src="{{ $message->embed('img/logo/logo_aqua.png') }}"></a>
                                </td>
                            </tr>
                             <tr>
                        ...
                        <table width="40%"  border="0" cellpadding="0" cellspacing="0" align="right" class="deviceWidth">
                            <tr>
                                <td valign="top" style="padding: 40px 20px " class="center">
                                    <a href="#"><img width="300" hight="170" src="{{ $message->embed('img/block_img/picture2.jpg') }}"></a>
                                </td>
                            </tr>
                             <tr>
                                <td  class="center" style="font-size: 16px; color: #303030; font-weight: bold; text-align: center; font-family: Arial, Helvetica, sans-serif; line-height: 25px; vertical-align: middle; padding: 0px 10px;">
                        ...
                        <table width="30%"  border="0" cellpadding="0" cellspacing="0" align="center" class="deviceWidth">
                            <tr>
                                <td style=" padding: 15px 20px 30px;">
                                        <table  align="center">
                                            <tr>
                                                <td  valign="top" style="padding: 7px 15px; text-align: center; background-color: #27d7e7;" class="center">
                        ...
                        <tr>
                            <td width="100%" bgcolor="#f7f7f7"> 
                                ...
                                <table width="33%"  border="0" cellpadding="0" cellspacing="0" align="left" class="deviceWidth">
                                    <tr>
                                        <td valign="top" style="padding: 20px 30px " class="center">
                                            <a href="#"><img width="144" hight="144" src="{{ $message->embed('img/brands/natural.png') }}"></a>
                                        </td>
                                    </tr>
                                </table><!--End Image 1-->
                                <!--Start Image 2-->
                                <table width="33%"  border="0" cellpadding="0" cellspacing="0" align="left" class="deviceWidth">
                                    <tr>
                                        <td valign="top" style="padding: 20px 30px " class="center">
                                            <a href="#"><img width="144" hight="144" src="{{ $message->embed('img/brands/everyday.png') }}"></a>
                                        </td>
                                    </tr>
                                </table><!--End Image 2-->    
                                <!--Start Image 3-->
                                <table width="33%"  border="0" cellpadding="0" cellspacing="0" align="left" class="deviceWidth">
                                    <tr>
                                        <td valign="top" style="padding: 20px 30px " class="center">
                                            <a href="#"><img width="144" hight="144" src="{{ $message->embed('img/brands/gamescast.png') }}"></a>
                                        </td>
                                    </tr>
                                </table><!--End Image 3-->
                            </td>     
                        ...
                        <tr>
                            <td width="100%" bgcolor="#f7f7f7">
                                ...
                                <table width="33%"  border="0" cellpadding="0" cellspacing="0" align="left" class="deviceWidth">
                                    <tr>
                                        <td valign="top" style="padding: 20px 30px " class="center">
                                            <a href="#"><img width="144" hight="144" src="img/brands/cisco.png{{ $message->embed('img/logo/logo_aqua.png') }}"></a>
                                        </td>
                                    </tr>
                                </table><!--End Image 1-->
                                <!--Start Image 2-->
                                <table width="33%"  border="0" cellpadding="0" cellspacing="0" align="left" class="deviceWidth">
                                    <tr>
                                        <td valign="top" style="padding: 20px 30px " class="center">
                                            <a href="#"><img width="144" hight="144" src="img/brands/spinworkx.png{{ $message->embed('img/logo/logo_aqua.png') }}"></a>
                                        </td>
                                    </tr>
                                </table><!--End Image 2-->    
                                <!--Start Image 3-->
                                <table width="33%"  border="0" cellpadding="0" cellspacing="0" align="left" class="deviceWidth">
                                    <tr>
                                        <td valign="top" style="padding: 20px 30px " class="center">
                                            <a href="#"><img width="144" hight="144" src="img/brands/walmart.png{{ $message->embed('img/logo/logo_aqua.png') }}"></a>
                                        </td>
                                    </tr>
                                </table><!--End Image 3 -->
                            </td>     
                        ...
                        <table  border="0" cellpadding="0" cellspacing="0" align="center"> 
                            <tr>
                                <td valign="top" style="padding: 20px 10px " class="center">
                                    <a href="#"><img width="32" hight="32" src="img/icons/icon_facebook.png{{ $message->embed('img/logo/logo_aqua.png') }}"></a>
                                </td>
                                <td valign="top" style="padding: 20px 10px " class="center">
                                    <a href="#"><img width="32" hight="32" src="img/icons/icon_twitter.png{{ $message->embed('img/logo/logo_aqua.png') }}"></a>
                                </td>
                                <td valign="top" style="padding: 20px 10px " class="center">
                                    <a href="#"><img width="32" hight="32" src="img/icons/icon_youtube.png{{ $message->embed('img/logo/logo_aqua.png') }}"></a>
                                </td>
                            </tr>
                        </table>
                        <table  border="0" cellpadding="0" cellspacing="0" align="center"> 
                ...
                <tr>
                  ...
                  <tr>
                    <td  bgcolor="#ffffff" class="center" style="font-size: 12px; color: #687074; font-weight: bold; text-align: center; font-family: Arial, Helvetica, sans-serif; line-height: 25px; vertical-align: middle; padding: 20px 10px; " >
                         {{ $name }}, if you would prefer not to receive email communications from Unify Template click <a style="text-decoration: none; color: #27d7e7;" href="#">here</a>
                    </td>
                </tr>
            </table>
            <!--End Footer-->
